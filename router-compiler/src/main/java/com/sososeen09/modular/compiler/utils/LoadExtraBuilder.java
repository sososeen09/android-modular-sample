...
public class LoadExtraBuilder {
    ...
    public void buildStatement(Element extraElement) {
        TypeMirror typeMirror = extraElement.asType();
        int type = typeMirror.getKind().ordinal();

        //属性名 String text 获得text
        String fieldName = extraElement.getSimpleName().toString();
        String extraName = extraElement.getAnnotation(Extra.class).name();
        ...
        if (type == TypeKind.BOOLEAN.ordinal()) {
            ...
            if (type == TypeKind.ARRAY.ordinal()) {
                addArrayStatement(statement, fieldName, extraName, typeMirror, extraElement);
            } else {
                //Object
                addObjectStatement(statement, fieldName, extraName, typeMirror, extraElement);
            }
     ...
     * @param extraElement
     */
    private void addObjectStatement(String statement, String fieldName, String extraName, TypeMirror typeMirror, Element extraElement) {
        //Parcelable
...
//            testService.test();
            ...
            builder.addStatement(statement, TypeName.get(extraElement.asType()), Consts.ROUTER,
                    extraName);
            return;
        }else {
            //List
    ...
    private void addArrayStatement(String statement, String fieldName, String extraName, TypeMirror typeMirror, Element extraElement) {
